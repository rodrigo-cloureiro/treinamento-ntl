...
<script src="<?php echo ASSETS_URL; ?>/js/businessEstadoCivil.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function voltar() {
        $(location).attr('href', 'estadoCivilFiltro.php');
    }
    ...
    function gravar() {
        ...
        const descricao = $.trim($("#descricao").val()).toLowerCase();
        ...
        gravaEstadoCivil(codigo, descricao, ativo);
    }
</script>