...
$page_nav["tabelaBasica"]["sub"]["tipoDependente"]["active"] = true;
...
<script>
    ...
    function listarFiltro() {
        ...
        $('#resultadoBusca').load('tipoDependenteFiltroListagem.php?', {
            ativoFiltro:ativo,
    ...
    function novo() {
        $(location).attr('href', 'tipoDependenteCadastro.php');
    }
</script>