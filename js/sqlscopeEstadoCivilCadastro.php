...
function grava()
{
    ...
    $sql = " SELECT codigo FROM estado_civil WHERE descricao = $descricao ";
    ...
    $sql = "dbo.estadoCivilCadastro_Atualiza
        $codigo,
        $descricao,
        $ativo";  
...
function recupera()
{
    ...
    $sql = " SELECT codigo, descricao, ativo
             FROM cadastro.dbo.estado_civil WHERE (0 = 0) ";

    if ($condicaoId) {
        $sql = $sql . " AND estado_civil.codigo = " . $usuarioIdPesquisa . " ";
    }
...
function excluir()
{
    ...
    $sql = "dbo.excluir_estadoCivil " . $id;
